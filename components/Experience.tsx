      ...
      <div className="container">
        ...
        <div className="mb-6">
          ...
          <ul className="list-disc pl-6 mt-2 text-gray-300">
            ...
            <li>Administered Active Directory and Microsoft 365, improving reliability and user productivity.</li>
        ...
        <div className="mb-6">
          ...
          <ul className="list-disc pl-6 mt-2 text-gray-300">
            <li>Trained and supported customers across Apple’s ecosystem, increasing confidence and satisfaction.</li>
